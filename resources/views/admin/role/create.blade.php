...
@section('content')
    <section class="content">
        <form method="POST" action="/admin/permission/save" accept-charset="UTF-8" class="form-horizontal" role="form" id="create-permission"><input name="_token" type="hidden" value="{{ csrf_token() }}">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-lg-2 control-label">Display Name</label>
                        <div class="col-lg-10">
